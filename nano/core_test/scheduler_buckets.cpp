...
{
	nano::scheduler::buckets buckets;
	buckets.push (1000, block0 (), nano::MBAN_ratio);
...
{
	nano::scheduler::buckets buckets;
	buckets.push (1000, block1 (), nano::BAN_ratio);
	ASSERT_EQ (1, buckets.size ());
...
TEST (buckets, insert_same_priority)
{
	nano::scheduler::buckets buckets;
	buckets.push (1000, block0 (), nano::MBAN_ratio);
	buckets.push (1000, block2 (), nano::MBAN_ratio);
...
TEST (buckets, insert_older)
{
	nano::scheduler::buckets buckets;
	buckets.push (1000, block0 (), nano::MBAN_ratio);
	buckets.push (1100, block2 (), nano::MBAN_ratio);
...
TEST (buckets, top_two)
{
	nano::scheduler::buckets buckets;
	buckets.push (1000, block0 (), nano::MBAN_ratio);
	buckets.push (1, block1 (), nano::BAN_ratio);
	ASSERT_EQ (block0 (), buckets.top ());
	buckets.pop ();
...
TEST (buckets, top_round_robin)
{
	...
	buckets.push (1000, block0 (), nano::MBAN_ratio);
	buckets.push (1000, block1 (), nano::BAN_ratio);
	buckets.push (1100, block3 (), nano::BAN_ratio);
