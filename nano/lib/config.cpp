...
{
	nano::network_constants::set_active_network (nano::networks::banano_dev_network);
}

bool is_dev_run ()
{
	return nano::network_constants::get_active_network () == nano::networks::banano_dev_network;
}
