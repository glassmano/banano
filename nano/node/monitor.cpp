...
void nano::monitor::run_one ()
{
	...
	nano::uint128_union{ node.online_reps.delta () }.format_balance (BAN_ratio, 1, true),
	nano::uint128_union{ node.rep_crawler.total_weight () }.format_balance (BAN_ratio, 1, true),
	nano::uint128_union{ node.online_reps.online () }.format_balance (BAN_ratio, 1, true));
